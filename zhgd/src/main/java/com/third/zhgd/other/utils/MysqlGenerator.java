...
public class MysqlGenerator {
     ...
     * 包所在路径
     */
    private static final String  packagePath="com.third.zhgd";
    /**
     * baseEntity所在路径
     */
    private static final String baseEntity = packagePath+".other.utils.BaseEntity";
    /**
     * 实体所在的module
     */
    private static final String moduleName="Equipment";
    /**
     ...
     * 数据库表名，支持多个，用,隔开
     */
    private static final String bean="tb_equipment";
    /**,tb_book
     * 数据库k
     */
    private static final String database="zhgd_db";
    /**
     * 用户名
     */
