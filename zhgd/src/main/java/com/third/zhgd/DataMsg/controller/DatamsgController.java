package com.third.zhgd.DataMsg.controller;
...
public class DatamsgController {
    ...
    @ApiOperation(value = "保存修改Datamsg信息")
    @RequestMapping(method = RequestMethod.POST, value = "/save")
    public Result addOrUpdate(@RequestBody Datamsg datamsg) {
    ...
    public Result deleteByIds(String ids) {
        Result result = new Result();
        datamsgService.deleteByIds(ids);
        result.success("删除成功");
        return result;
    }
    ...
    public Result list(){
        ...
        result.setData(datamsgService.list());
        return result;
    }
    ...
    public Result page( Integer pageNum,Integer pageSize ){
        ...
        result.setData(datamsgService.page(pageNum,pageSize));
        return result;
    }
